<?php
	...
	include("../model/handlers/register-handler.php");
	include("../model/handlers/login-handler.php");
	...
	<div id="background">
		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				<form id="loginForm" action="../controller/register.php" method="POST">
				...
				<form id="registerForm" action="../controller/register.php" method="POST">
			...
			<div id="loginText">
				<h1>We will speak for the books</h1>
				<h2>Listen to loads of audiobooks for free</h2>
				<ul>
					<li>Audiobooks speak for themselves.</li>
					<li>Discover books you'll fall in love with</li>
					<li>Create your own playlists</li>
					<li>Follow book authors to keep up to date</li>
				</ul>
			</div>
