<?php
	...
	include("../controller/includes/classes/Account.php");
	include("../controller/includes/classes/Constant.php");
	$account = new Account($con);

	include("../controller/includes/handlers/register-handler.php");
	include("../controller/includes/handlers/login-handler.php");
